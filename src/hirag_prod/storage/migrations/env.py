...
try:
    from hirag_prod.schema import Base, Chunk, File, Graph, Item, Node, Triplets
...
def get_database_url():
    ...
    if not db_url:
        ...
        env_var_name = "POSTGRES_URL_NO_SSL" if env_settings == "prod" else "POSTGRES_URL_NO_SSL_DEV"
...
try:
    ...
    if not db_url:
        raise ValueError("Database URL is not set. Please set POSTGRES_URL_NO_SSL_DEV or POSTGRES_URL_NO_SSL environment variable.")
