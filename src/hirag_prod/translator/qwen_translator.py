...
class QwenTranslator:
    ...
    async def translate(self, text, dest: str = "English", src: str = "Auto") -> Union[QwenTranslated, list[QwenTranslated]]:
        """
    ...
    async def _translate_single(self, text: str, dest: str = "English", src: str = "Auto") -> QwenTranslated:
    ...
    async def _translate_batch(self, texts: list[str], dest: str = "English", src: str = "Auto") -> list[QwenTranslated]:
